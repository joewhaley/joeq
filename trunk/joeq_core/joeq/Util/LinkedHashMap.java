 ...
 * <tt>JDK14HashMap</tt> in that it maintains a doubly-linked list running through
 ...
 * chaotic ordering provided by {@link JDK14HashMap} (and {@link Hashtable}),
 ...
 * permits null elements.  Like <tt>JDK14HashMap</tt>, it provides constant-time
 * performance for the basic operations (<tt>add</tt>, <tt>contains</tt> and
 * <tt>remove</tt>), assuming the the hash function disperses elements
 * properly among the buckets.  Performance is likely to be just slightly
 * below that of <tt>JDK14HashMap</tt>, due to the added expense of maintaining the
 * linked list, with one exception: Iteration over the collection-views
 * of a <tt>LinkedHashMap</tt> requires time proportional to the <i>size</i>
 * of the map, regardless of its capacity.  Iteration over a <tt>JDK14HashMap</tt>
 * is likely to be more expensive, requiring time proportional to its
 * <i>capacity</i>.
 *
 * <p>A linked hash map has two parameters that affect its performance:
 * <i>initial capacity</i> and <i>load factor</i>.  They are defined precisely
 * as for <tt>JDK14HashMap</tt>.  Note, however, that the penalty for choosing an
 * excessively high value for initial capacity is less severe for this class
 * than for <tt>JDK14HashMap</tt>, as iteration times for this class are unaffected
 * by capacity.
 * 
...
public class LinkedHashMap extends JDK14HashMap {
    /**
     ...
     */
    void transfer(JDK14HashMap.Entry[] newTable) {
     ...
     * LinkedHashMap entry.
     */
    private static class Entry extends JDK14HashMap.Entry {
