...
public class CollectionTestWrapper implements Set, SortedSet, List {
    ...
    public static class TestIterator implements Iterator {
        ...
        public Object next() {
            ...
            if (stable || !removed) {
                ...
                if (stable) 
                    if (r1 != r2)
                        jq.UNREACHABLE("c1="+c1+" c2="+c2+" "+r1+" != "+r2);
            }
            lastRet = r1;
            return r1;
        }
    ...
    public boolean add(Object arg0) {
        ...
        jq.Assert(r1 == r2);
        jq.Assert(c1.contains(arg0));
        jq.Assert(c2.contains(arg0));
        return r1;
    }
    ...
    public boolean addAll(Collection arg0) {
        ...
        jq.Assert(r1 == r2);
        jq.Assert(c1.containsAll(arg0));
        jq.Assert(c2.containsAll(arg0));
        jq.Assert(c1.size() == c2.size());
        return r1;
    }
    ...
    public boolean removeAll(Collection arg0) {
        ...
        for (Iterator i=arg0.iterator(); i.hasNext(); ) {
            Object o = i.next();
            jq.Assert(!c1.contains(o));
            jq.Assert(!c2.contains(o));
        }
        jq.Assert(c1.size() == c2.size());
        return r1;
    }
    ...
    public boolean addAll(int arg0, Collection arg1) {
        ...
        jq.Assert(r1 == r2);
        jq.Assert(c1.containsAll(arg1));
        jq.Assert(c2.containsAll(arg1));
        jq.Assert(c1.size() == c2.size());
        return r1;
    }
    ...
    public Object set(int arg0, Object arg1) {
        ...
        jq.Assert(r1 == r2);
        jq.Assert(((List)c1).get(arg0) == arg1);
        jq.Assert(((List)c2).get(arg0) == arg1);
        jq.Assert(c1.size() == c2.size());
        return r1;
    }
