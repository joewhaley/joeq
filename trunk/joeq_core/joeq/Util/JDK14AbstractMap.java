...
public abstract class JDK14AbstractMap implements Map {
    /**
     * Sole constructor.  (For invocation by subclass constructors, typically
     * implicit.)
     */
    protected JDK14AbstractMap() {
    }
    ...
    /**
     * Returns a shallow copy of this <tt>JDK14AbstractMap</tt> instance: the keys
     * and values themselves are not cloned.
     *
     * @return a shallow copy of this map.
     */
    protected Object clone() throws CloneNotSupportedException {
        JDK14AbstractMap result = (JDK14AbstractMap)super.clone();
        result.keySet = null;
        result.values = null;
        return result;
    }
