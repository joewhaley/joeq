...
public class ANSIColorStream extends PrintStream {
    ...
    public static ANSIColorStream blue = new ANSIColorStream(System.out, ANSIColorStream.BLUE);
    public static ANSIColorStream red = new ANSIColorStream(System.out, ANSIColorStream.RED);
    public static ANSIColorStream green = new ANSIColorStream(System.out, ANSIColorStream.GREEN);
    public static ANSIColorStream cyan = new ANSIColorStream(System.out, ANSIColorStream.CYAN);
