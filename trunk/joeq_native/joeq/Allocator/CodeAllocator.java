...
public abstract class CodeAllocator {
     ...
     * generated by us. */
    private static CodeAddress lowAddress = CodeAddress.max(),
                                highAddress = CodeAddress.min();
    static {
        compiledMethods = new TreeMap();
        jq_CompiledCode cc = new jq_CompiledCode(null, CodeAddress.min(), 0, CodeAddress.min(),
