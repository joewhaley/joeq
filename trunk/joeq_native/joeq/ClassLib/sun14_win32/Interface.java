...
public final class Interface extends ClassLib.ClassLibInterface {
    ...
    public java.lang.Class createNewClass(Clazz.jq_Type f) {
        return ClassLib.sun14_win32.java.lang.Class.createNewClass(ClassLib.sun14_win32.java.lang.Class._class, f);
    }
    
    public java.lang.reflect.Constructor createNewConstructor(Clazz.jq_Initializer f) {
        return ClassLib.sun14_win32.java.lang.reflect.Constructor.createNewConstructor(ClassLib.sun14_win32.java.lang.reflect.Constructor._class, f);
    }
    
    public void initNewConstructor(java.lang.reflect.Constructor o, Clazz.jq_Initializer f) {
        ClassLib.sun14_win32.java.lang.reflect.Constructor.initNewConstructor(o, f);
    }
    
    public java.lang.reflect.Field createNewField(Clazz.jq_Field f) {
        return ClassLib.sun14_win32.java.lang.reflect.Field.createNewField(ClassLib.sun14_win32.java.lang.reflect.Field._class, f);
    }
    
    public void initNewField(java.lang.reflect.Field o, Clazz.jq_Field f) {
        ClassLib.sun14_win32.java.lang.reflect.Field.initNewField(o, f);
    }

    public java.lang.reflect.Method createNewMethod(Clazz.jq_Method f) {
        return ClassLib.sun14_win32.java.lang.reflect.Method.createNewMethod(ClassLib.sun14_win32.java.lang.reflect.Method._class, f);
    }
    
    public void initNewMethod(java.lang.reflect.Method o, Clazz.jq_Method f) {
        ClassLib.sun14_win32.java.lang.reflect.Method.initNewMethod(o, f);
    }
    
    public Clazz.jq_Field getJQField(java.lang.reflect.Field f) {
        return (Clazz.jq_Field)Reflection.getfield_A(f, ClassLib.sun14_win32.java.lang.reflect.Field._jq_field);
    }
    
    public Clazz.jq_Initializer getJQInitializer(java.lang.reflect.Constructor f) {
        return (Clazz.jq_Initializer)Reflection.getfield_A(f, ClassLib.sun14_win32.java.lang.reflect.Constructor._jq_init);
    }
    
    public Clazz.jq_Method getJQMethod(java.lang.reflect.Method f) {
        return (Clazz.jq_Method)Reflection.getfield_A(f, ClassLib.sun14_win32.java.lang.reflect.Method._jq_method);
    }
    
    public Scheduler.jq_Thread getJQThread(java.lang.Thread t) {
        return (Scheduler.jq_Thread)Reflection.getfield_A(t, ClassLib.sun14_win32.java.lang.Thread._jq_thread);
    }
    
    public Clazz.jq_Type getJQType(java.lang.Class k) {
        return (Clazz.jq_Type)Reflection.getfield_A(k, ClassLib.sun14_win32.java.lang.Class._jq_type);
    }
    
    public Clazz.jq_Type getOrCreateType(java.lang.ClassLoader cl, UTF.Utf8 desc) {
        return ClassLib.sun14_win32.java.lang.ClassLoader.getOrCreateType(cl, desc);
    }
    ...
    public void open(java.io.RandomAccessFile dis, java.lang.String name, boolean writeable) throws java.io.FileNotFoundException {
        ClassLib.sun14_win32.java.io.RandomAccessFile.open(dis, name, writeable);
    }
    
    public void unloadType(java.lang.ClassLoader cl, Clazz.jq_Type t) {
        ClassLib.sun14_win32.java.lang.ClassLoader.unloadType(cl, t);
    }
