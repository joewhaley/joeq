...
public abstract class Thread {
    ...
    public static void __init__(java.lang.Thread dis) {
        ...
        try {
            ...
            Reflection.invokeinstance_V(_init, dis, null, null, "Thread-"+n, 0L);
    ...
    public static void __init__(java.lang.Thread dis, java.lang.Runnable target) {
        ...
        try {
            int n = Reflection.invokestatic_I(_nextThreadNum);
            Reflection.invokeinstance_V(_init, dis, null, target, "Thread-"+n, 0L);
        } catch (java.lang.Error x) {
            throw x;
        } catch (java.lang.Throwable x) {
            jq.UNREACHABLE();
    ...
    public static void __init__(java.lang.Thread dis, java.lang.ThreadGroup group, java.lang.Runnable target) {
        ...
        try {
            int n = Reflection.invokestatic_I(_nextThreadNum);
            Reflection.invokeinstance_V(_init, dis, group, target, "Thread-"+n, 0L);
        } catch (java.lang.Error x) {
            throw x;
        } catch (java.lang.Throwable x) {
            jq.UNREACHABLE();
    ...
    public static void __init__(java.lang.Thread dis, java.lang.String name) {
        ...
        jq.assert(_class.isClsInitialized());
        try {
            Reflection.invokeinstance_V(_init, dis, null, null, name, 0L);
        } catch (java.lang.Error x) {
            throw x;
        } catch (java.lang.Throwable x) {
            jq.UNREACHABLE();
    ...
    public static void __init__(java.lang.Thread dis, java.lang.ThreadGroup group, java.lang.String name) {
        ...
        jq.assert(_class.isClsInitialized());
        try {
            Reflection.invokeinstance_V(_init, dis, group, null, name, 0L);
        } catch (java.lang.Error x) {
            throw x;
        } catch (java.lang.Throwable x) {
            jq.UNREACHABLE();
    ...
    public static void __init__(java.lang.Thread dis, java.lang.Runnable target, java.lang.String name) {
        ...
        jq.assert(_class.isClsInitialized());
        try {
            Reflection.invokeinstance_V(_init, dis, null, target, name, 0L);
        } catch (java.lang.Error x) {
            throw x;
        } catch (java.lang.Throwable x) {
            jq.UNREACHABLE();
    ...
    public static void __init__(java.lang.Thread dis, java.lang.ThreadGroup group, java.lang.Runnable target, java.lang.String name) {
        ...
        jq.assert(_class.isClsInitialized());
        try {
            Reflection.invokeinstance_V(_init, dis, group, target, name, 0L);
        } catch (java.lang.Error x) {
            throw x;
        } catch (java.lang.Throwable x) {
            jq.UNREACHABLE();
    ...
    public static void __init__(java.lang.Thread dis, java.lang.ThreadGroup group, java.lang.Runnable target, java.lang.String name, long stackSize) {
        jq_Thread t = new jq_Thread(dis);
        Reflection.putfield_A(dis, _jq_thread, t);
        jq.assert(_class.isClsInitialized());
        try {
            Reflection.invokeinstance_V(_init, dis, group, target, name, stackSize);
        } catch (java.lang.Error x) {
            throw x;
        } catch (java.lang.Throwable x) {
            jq.UNREACHABLE();
    ...
    public static final jq_InstanceMethod _init = _class.getOrCreateInstanceMethod("init", "(Ljava/lang/ThreadGroup;Ljava/lang/Runnable;Ljava/lang/String;J)V");
}
