...
public abstract class CodeAllocator {
     ...
     */
    public abstract void patchAbsolute(int/*CodeAddress*/ code,
                                         int/*HeapAddress*/ heap);
     ...
     */
    public abstract void patchRelativeOffset(int/*CodeAddress*/ code,
                                               int/*CodeAddress*/ target);
     ...
     * generated by us. */
    private static int/*CodeAddress*/ lowAddress = Integer.MAX_VALUE,
                                        highAddress = 0;
    static {
    ...
    public static class InstructionPointer implements Comparable {
        ...
        /**  Returns the hash code of this instruction pointer.  We use the
         * pointer value itself.  NOTE that this cannot be used when comparing
         * with jq_CompiledCode objects.
         * @return  hash code
         */
    ...
    static {
        ...
        _compiledMethods = k.getOrCreateStaticField("compiledMethods", "Ljava/util/SortedMap;");
