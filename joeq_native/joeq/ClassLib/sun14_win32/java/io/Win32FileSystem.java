...
public abstract class Win32FileSystem {
    ...
    private static String getDriveDirectory(/*java.io.Win32FileSystem*/Object dis, int i) {
        byte[] b = new byte[256];
    ...
    public static String canonicalize(/*java.io.Win32FileSystem*/Object dis, String s) throws java.io.IOException {
    ...
    public static int getBooleanAttributes(/*java.io.Win32FileSystem*/Object dis, java.io.File file) {
    ...
    public static boolean checkAccess(/*java.io.Win32FileSystem*/Object dis, java.io.File file, boolean flag) {
        int res = SystemInterface.fs_access(file.getPath(), flag?2:4);
        return res == 0;
    }

    public static long getLastModifiedTime(/*java.io.Win32FileSystem*/Object dis, java.io.File file) {
        long res = SystemInterface.fs_getfiletime(file.getPath());
        return res;
    }

    public static long getLength(/*java.io.Win32FileSystem*/Object dis, java.io.File file) {
        return SystemInterface.fs_stat_size(file.getPath());
    }
    
    public static boolean delete(/*java.io.Win32FileSystem*/Object dis, java.io.File file) {
        int res = SystemInterface.fs_remove(file.getPath());
        return res == 0;
    }
    
    public static String[] list(/*java.io.Win32FileSystem*/Object dis, java.io.File file) {
    ...
    public static boolean createDirectory(/*java.io.Win32FileSystem*/Object dis, java.io.File file) {
        int res = SystemInterface.fs_mkdir(file.getPath());
        return res == 0;
    }

    public static boolean rename(/*java.io.Win32FileSystem*/Object dis, java.io.File file, java.io.File file1) {
        int res = SystemInterface.fs_rename(file.getPath(), file1.getPath());
        return res == 0;
    }

    public static boolean setLastModifiedTime(/*java.io.Win32FileSystem*/Object dis, java.io.File file, long l) {
        int res = SystemInterface.fs_setfiletime(file.getPath(), l);
        return res != 0;
    }

    public static boolean setReadOnly(/*java.io.Win32FileSystem*/Object dis, java.io.File file) {
        int res = SystemInterface.fs_chmod(file.getPath(), SystemInterface._S_IREAD);
        return res == 0;
    }

    private static int listRoots0(jq_Class clazz) {
